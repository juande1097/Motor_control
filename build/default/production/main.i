...
double ganancia_a = 10.75;
double ganancia_b = -0.3136;
double ganancia_c = 0.1;
...
void __attribute__((picinterrupt(("high_priority")))) high(void)
{
    if (SSPIF == 1 && SSPIE == 1) {
        SSPIF = 0;
